...
Слой Domain хранит в себе классы сущностей Drink, Coin и Machine. Все последующие слои будут хранить ссылку на слой Domain, но сам слой Domain ничего не знает о других слоях.
