...
-Содержит Feature папки Drinks, Coins, Machines в которых содержатся запросы и команды над данными сущностями,а также фабричные методы создания напитков и монет.

-Содержит папку Services, где хранится сервис покупки напитка
